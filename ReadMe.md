...
## Current Goals
The current Goals are to enable TempleOS to be installed natively and self contained on as many PC's as possible (the idea being no tols outside of TempleOS are required for Build, Boot, Install)
